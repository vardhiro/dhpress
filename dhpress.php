        ...
        if(isset($_GET['admin'])){
            if($_GET['admin'] == 'login'){
                ...
                echo"<script>location.href='?admin=login'</script>";
                    ...
                    echo"<script>CKEDITOR.replace( 'post' ) </script>";
                    ...
                    if(isset($_POST['title'])&&isset($_POST['post'])){
                        ...
                        if($num==0){
                            $i = "INSERT INTO post (title,post,clock,editclock, views) VALUES ('$title','$post','$time', '', '0')";
            ...
            if($num>0){
                while ($row = mysqli_fetch_array($q)) {
                    ...
                    if($row['editclock']!=''){
                        echo"<br>Edited last on ".$row['editclock'];
                    }
            ...
            if(isset($_SESSION['username'])&&$_SESSION['username']==admin&&isset($_SESSION['password'])&&$_SESSION['password']==pass){
                echo"<a href='?admin=logout'>Logout</a><br><br>";
            }
            if($num>0){
                while ($row = mysqli_fetch_array($q)) {
